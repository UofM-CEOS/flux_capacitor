...
;; Last-Updated: 2013-10-01T19:50:59+0000
;;           By: Sebastian Luque
;; ------------------------------------------------------------------------
;;; Commentary: 
;; 
...
;; CALLING SEQUENCE:
;; 
;;  STD_OMG, Idir, Odir, Itemplate_Sav, Time_Beg_Idx, Oheader
;; 
;; INPUTS:
;; 
...
;; EXAMPLE:
;; 
;; omg_std_header='year, month, day, hour, minute, second, ' + $
;;                'latitude, longitude, SOG, COG'
;; STD_OMG, expand_path('~/tmp/OMG'), expand_path('~/tmp/OMG/STD'), $
;;          'omg_raw_template.sav', 1, omg_std_header
;; 
;; - ----------------------------------------------------------------------
;;; Code:

PRO STD_OMG, IDIR, ODIR, ITEMPLATE_SAV, TIME_BEG_IDX, OHEADER, $
             OVERWRITE=OVERWRITE
